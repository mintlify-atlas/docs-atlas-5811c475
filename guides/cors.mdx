...
sidebarTitle: "CORS"
description: "QR Code Generator uses an origin allowlist to control cross-origin API access. Set ALLOWED_ORIGINS in wrangler.jsonc to enable CORS from your frontend domains."
---
